...
export function drawLetterBanner(doc, { eyebrow, tag, tagStyle, subhead = 'Majestic Construction Permits LLC', wordmark = 'MAJESTIC PERMITS' }) {
  const W = PAGE_W;
...
export function drawSignatureAndFooter(doc, y, opts = {}) {
  const {
    ...
    signOffSub = 'Majestic Construction Permits LLC',
    phone = '561-888-3805',
...
export function drawNoticeLetter(doc, level, data) {
  ...
  doc.setTextColor(92, 92, 92);
  wrapText(doc,
    'This is a courtesy notice from Majestic Construction Permits LLC, a private permit resolution service. ' +
  ...
  y += mm(0.28);
  y = drawHelpPoints(doc, y, 'How Majestic Permits Can Help', HELP_POINTS);
