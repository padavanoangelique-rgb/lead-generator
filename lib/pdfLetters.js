...
export function drawLetterBanner(doc, { eyebrow, tag, tagStyle, subhead = 'A division of Majestic Construction Permits LLC', wordmark = 'THE PERMIT CLOSER' }) {
  const W = PAGE_W;
...
export function drawSignatureAndFooter(doc, y, opts = {}) {
  const {
    ...
    signOffSub = 'A division of Majestic Construction Permits LLC',
    phone = '561-888-3805',
...
export function drawNoticeLetter(doc, level, data) {
  ...
  doc.setTextColor(92, 92, 92);
  wrapText(doc,
    'This is a courtesy notice from The Permit Closer, a private permit resolution service and a division of Majestic Construction Permits LLC. It is not issued by, and is not affiliated with, any city, county, or government building department.',
